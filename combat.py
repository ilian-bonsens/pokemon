...
class Pokemon(pygame.sprite.Sprite):
    ...
    def draw(self, alpha=255):
        ...
        fenetre.ecran.blit(sprite, (self.x, self.y))
    ...
    def draw_hp(self):
        ...
        for i in range(self.max_hp):
            ...
            pygame.draw.rect(fenetre.ecran, red, bar)
            
        for i in range(self.current_hp):
            bar = (self.hp_x + bar_scale * i, self.hp_y, bar_scale, 20)
            pygame.draw.rect(fenetre.ecran, green, bar)
...
def display_message(message):
    ...
    pygame.draw.rect(fenetre.ecran, white, (10, 350, 480, 140))
    pygame.draw.rect(fenetre.ecran, black, (10, 350, 480, 140), 3)
...
def create_button(width, height, left, top, text_cx, text_cy, label):
    ...
    if button.collidepoint(mouse_cursor):
        pygame.draw.rect(fenetre.ecran, gold, button)
    else:
...
level = 30
mewtwo = Pokemon('mewtwo', level, 25, 150)
arceus = Pokemon('arceus', level, 175, 150)
rayquaza = Pokemon('rayquaza', level, 325, 150)
pokemons = [mewtwo, arceus, rayquaza]
    ...
    if game_status == 'select pokemon':
        ...
        for pokemon in pokemons:
            ...
            if pokemon.get_rect().collidepoint(mouse_cursor):
                pygame.draw.rect(fenetre.ecran, black, pokemon.get_rect(), 2)
